...
public final class Driver {
    ...
    public static boolean isLandscape(){
        log.info(MyLogger.getMethodName());
        log.info("isLandscape()中利用Driver自带的pageSourceDriver.driver.getPageSource():"+Driver.driver.getPageSource());
        log.info("isLandscape()中利用二次封装的Driver.getPageSource():"+Driver.getPageSource());
        boolean ret = false;
        try {
            ...
            log.info("isLandscape()中利用Driver自带的pageSourceDriver.driver.getPageSource1():"+Driver.driver.getPageSource());
            log.info("isLandscape()中利用二次封装的Driver.getPageSource1():"+Driver.getPageSource());
...
//        capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "UiAutomator1");
        ...
        {
            log.info("Using uiautomator");
            //capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "UIAutomator");
            capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "UiAutomator1");//设置Driver为
        }
        ...
        log.info("url:"+url);
        log.info("new URL(url):"+new URL(url));
        log.info("capabilities:"+capabilities);
    ...
    public static String startLogRecord(){
        ...
        Runnable newRunnable = () -> {
            ...
            if(Util.isAndroid()){
                ...
                cmd.add("idevicesyslog -u " + ConfigUtil.getUdid() + " > " + logName);//查看系统日志
            }
        ...
        thread.start();
        log.info("startLogRecord中logName为:"+logName);
        return logName;
    }

    public static String getPlatformName() {
        String platform=driver.getPlatformName().toUpperCase();
...
//        return driver.getPlatformName().toUpperCase();
    ...
    public static void swipeHorizontally(boolean leftToRight) {
        log.info(MyLogger.getMethodName());
        log.info("Method : swipeHorizontally");
